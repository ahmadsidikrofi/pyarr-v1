                        ...
                        <div class="card-body">
                            ...
                            <div class="card">
                                <div class="card-header col-sm-3">
                                    <img src="/assets/images/{{ $detailPiring->image }}" width="200" height="200"
                                        alt="">
                                </div>
                                <div class="card-body col-sm-7">
                                    <div class="mb-3">
                                        <form action="/pinjam-piring/{{ $detailPiring->slug }}" method="post"
                                            ...
                                            <p class="p-2 bg-primary text-white fw-bold rounded-3">Piring terpinjam : {{
                                                $totalPinjam }}</p>
                                            @if ($totalPinjam >= 2)
                                            <button class="btn btn-success btn-md" disabled type="submit">Pinjam
                                                sekarang</button>
                                            @else
                                            <button class="btn btn-success btn-md" type="submit">Pinjam
                                                sekarang</button>
                                            @endif
                                        </form>
                                    </div>
